...
| 2026-08-27 | **P2 分类与路由治理**：img 分层(hero/music/brand/misc + 保留 covers/projects);动画脚本迁 `rose-galaxy/animation/`;空目录清理;版本号统一 `?v=20260827-p2`;assets 扁平化(`assets/projects/<工程名>/`,去 files/mcu|model 双层);permalink → `posts/:title/`(文章详情与 articles/ 并列);预览图入 img/misc |
